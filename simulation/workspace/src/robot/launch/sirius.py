...
def generate_launch_description():
    ...
    rsp = IncludeLaunchDescription(
        ...
        )]), launch_arguments={'world': '$(find robot)/worlds/my_office.world'}.items()
    )

    maze_world = os.path.join(get_package_share_directory(
        package_name), 'worlds', 'my_office.world')
    ...
    slam_toolbox_config = os.path.join(get_package_share_directory(
